...
if (typeof dojo == "undefined") {
    ...
    (function () {
        ...
        dojo._loadModule = dojo.require = function (_41, _42) {
            ...
            var _44 = this._getModuleSymbols(_41).join("index.html") + ".js";
        ...
        var ore = new RegExp("%5e((%5b%5e_/indexd41d.html?#]+):)?(//([^/?#]*))?([^?#]*)(\\?([^#]*))?(#(.*))?$");
                ...
                if ((_5d.path == "") && (!_5d.scheme) && (!_5d.authority) && (!_5d.query)) {
                    ...
                    if (!_5d.scheme) {
                        ...
                        if (!_5d.authority) {
                            ...
                            if (_5d.path.charAt(0) != "index.html") {
                                var _5f = _5e.path.substring(0, _5e.path.lastIndexOf("index.html") + 1) + _5d.path;
                                var _60 = _5f.split("index.html");
        ...
        dojo.moduleUrl = function (_63, url) {
            var loc = dojo._getModuleSymbols(_63).join("index.html");
            if (!loc) {
                return null;
            }
            if (loc.lastIndexOf("index.html") != loc.length - 1) {
                loc += "index.html";
            }
            var _66 = loc.indexOf(":");
            if (loc.charAt(0) != "/" && (_66 == -1 || _66 > loc.indexOf("index.html"))) {
                loc = d.baseUrl + loc;
            }
    ...
    if (typeof window != "undefined") {
        ...
        (function () {
            ...
            if (dav.indexOf("Safari") >= 0) {
                d.isSafari = parseFloat(dav.split("Version/index.html")[1]) || 2;
            }
            ...
            try {
                if (d.isMoz) {
                    d.isFF = parseFloat(dua.split("Firefox/index.html")[1].split(" ")[0]);
                }
...
if (!dojo._hasResource["dojo.i18n"]) {
    ...
    dojo.i18n._requireLocalization = function (_672, _673, _674, _675) {
        ...
        if (!_67d) {
            ...
            var _681 = syms.concat("nls").join("index.html");
            var _682;
            dojo.i18n._searchLocalePath(_67b, _675, function (loc) {
                ...
                if (!dojo._loadedModules[_685]) {
                    ...
                    _687.push(_673);
                    var _688 = _687.join("index.html") + ".js";
