     <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <form role="form" enctype="multipart/form-data" method="post" id="custom_fom" action="<?php echo base_url("admin/suggestion/save");?>">
																...
																<?php 
																    if(isset($books)&&!empty($books)){
																     foreach ($books as $lkey => $lvalue) { ?>
																      	<option value="<?php echo $lvalue['id'];?>"><?php echo $lvalue['name'];?></option> 
			            ...
			            <div class="row">
					        <div class="form-group">    
				                <button type="submit" id="save_custom_values" data-url="<?php echo base_url("admin/suggestion/save");?>"  data-config="save" class="btn btn-default">Save Details</button>
															...
															?>
															  <tr id="course_list_tr_<?php echo $row['id'];?>">
															    ...
															    <td style="position:relative;">
															    	...
															    	<form style="display: inline-block;" id="course_form_<?php echo $row['id'];?>" class="course_edit_form" action="<?php echo base_url("admin/bodhitreebooks/".$active."/edit");?>" method="post">
															    	...
															    	<br/><a id="gggggg"  class="seo_de_a"  href="<?php echo base_url("admin/global-seo-settings/posts/".strtolower(isset($active)?$active:"")."/".strtolower(isset($actived)?$actived:"")."/".$row['id']);?>"><i class="fa fa-search list_delete_s"></i>seo</a>
															    	<div class="remove_c_spin_1"  title="Please Wait.."><i class="fa fa-refresh fa-spin"></i></div>
															    </td>
															    <td><article><div class="tble_content_edtd">
						                                        	<span><?php echo substr(strip_tags($row['content']),0,250); ?></span>
						                                        	
						                                        </div></article>
						                                        </td>
						                                        <td><article><div class="tble_category_edt">
						                                        	<?php if(isset($author_list)){
																				foreach($author_list as  $vrow){
																					if($vrow['id']==$row['meta_id']){
																						echo $vrow['name'];
																					} 
																					?>
						                                        ...
						                                        <td><article><div class="tble_category_edt">
						                                        	...
						                                        	<span><?php if(isset($books)){
																				foreach($books as  $vrow){
																					if($vrow['id']==$row['meta_file']){
																						echo $vrow['name'];
																					} 
																					?>
															    ...
															    <td class="status-indication" >
															    	 <form class="display_show" id="status_change_<?php echo $row['id'];?>" method="post" action="<?php echo base_url('admin/bodhitreebooks/suggestion/status');?>">
