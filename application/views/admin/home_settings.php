     <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <form role="form" enctype="multipart/form-data" method="post" action="<?php echo base_url('admin/web-settings/slider/home-builder/home-settings/slider-one/save');?>">
                ...
                <form role="form" enctype="multipart/form-data" method="post" action="#">
		                ...
		                <button type="submit" id="save_seo_content" data-url="<?php echo base_url("admin/seo-settings/home/seo");?>"; class="btn btn-default">Save Changes</button>
