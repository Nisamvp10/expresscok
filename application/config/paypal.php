 ...
 */
$config['APIUsername'] = $config['Sandbox'] ? 'nikhilkps_api1.yahoo.com' : 'nikhilkps_api1.yahoo.com';
$config['APIPassword'] = $config['Sandbox'] ? 'NYHUGN68JNLZUXWM' : 'NYHUGN68JNLZUXWM';
$config['APISignature'] = $config['Sandbox'] ? 'AFcWxV21C7fd0v3bYYYRCpSSRl31A.P0HrT2Xs6vyUPa11rhXrlQE2xV' : 'PRODUCTION_SIGNATURE_GOES_HERE';
