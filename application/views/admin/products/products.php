     <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header">
                            Express International- Products
				...
				<input id="file" class="img_tag" type="hidden" name="file" accept="image/*"  >
			                		...
			                		<div class="row">
						                    ...
						                    <div class="col-lg-6">
							               	            <div class="form-group">
							                                ...
							                                <input  class="form-control"  name="track_url">
									...
									<div class="row d-none">
						                    ...
						                    <div class="col-lg-6">
												<div class="form-group">
													...
													<input  class="form-control"  name="address_receiver">
								...
								<div class="checkbox-large">
								 ...
								 <?php $reslbl=""; $reslval="";
								  ...
								  <?php if((isset($f_c)&&!empty($f_c))||(isset($p_code)&&!empty($p_code))||(isset($p_name)&&!empty($p_name))){ ?>
								  	...
								  	<div class="checkbox-large">	
										 	<div class="srch_rslt_indctr"><?php echo $reslbl; ?> "<span><?php echo urldecode($reslval);?></span>"</div>
								    </div>	
