...
<head>
    ...
    <?php $base_url="http://localhost/logistics/"; ?>
		                  ...
		                  <div class="bdy_cont_ch1">
		                  	   ...
		                  	   <div class="bdy_cont_ch2">
		                  	   	   ...
		                  	   	   <div class="main_e_m_sub_dwndiv">
			                  	   	   ...
			                  	   	   <div class="down_er_dv">
			                  	   	   	   This is because an internal error occured at server.The error message shown in below,
			                  	   	   	    <div style="padding: 14px;background-color: #ddf;"><h4><?php echo $heading; ?></h3>
			                  	   	   	    <small><?php echo $message; ?></small></div> 
			                  	   	   </div>
		                  	   	   </div>
		                  	   	   <div class="main_e_m_sub_dwndiv">
