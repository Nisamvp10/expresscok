...
// Created: 3/21/2012 3:09:29 PM
// Updated to include IP anonymization and all links tracking 3/29/2012
(function (_window, _document, _navigator, _location) {
    ...
    Webtrends.dcs.prototype = {
        init: function (config) {
            ...
            if (sd('alllinks', false)) this.addAllLinkTracking();
        ...
        addSelectorReal: function (dcs, selector, o) {
            ...
            if (find && o['event']) {
                ...
                var type = srcElm.tagName ? srcElm.tagName.toLowerCase() : "";
                /*in the case of a simple selector don't bother looping through them all*/
        ...
        dcsFPC: function () {
            ...
            //anonymization:
            if (WT["co_f"].indexOf("-") > -1) {                                  	//we have a ip address in WT.co_f
                ...
                this.DCS["dcscip"] = sTempLeft;                                   	//set dcscip to masked ip
            }
            else {
                this.DCS["dcscip"] = WT["co_f"];                                   	//set dcssip to script generated id
            }
        ...
        dcsVar: function () {
            ...
            WT["ssl"] = (_location.protocol.indexOf('en.html') == 0) ? "1" : "0";
        ...
        dcsTag: function (o) {
            ...
            var i18n = this['i18n'];
            var P = "http" + (_location.protocol.indexOf('en.html') == 0 ? 's' : '') + "://" + this['domain'] + (this['dcsid'] == "" ? '' : '/' + this['dcsid']) + "/dcs.gif?";
            if (i18n) {
                WT["dep"] = "";
            }
            for (var N in DCS) {
...
/*
            DHL SECURITY change. Do not embed browser sourced data in response.
 */
            //m += "<br><h3>Cookies</h3><br><code>" + document.cookie.replace(/\;/g, "<br>") + "</code><br>";
            m += "<br><h3>Cookies</h3><br><code>DHL:won't display cookie data here due security</code><br>";
/*
...
*/
        ...
        getURIArrFromEvent: function (e) {
            ...
            res.dcsuri = e.pathname ? ((e.pathname.indexOf("index.html") != 0) ? "/" + e.pathname : e.pathname) : "/";
        ...
        addOffsiteTracking: function () {
            ...
            this.addSelector('a', {
                filter: function (dcsObject, o) {
                    var e = o['element'] || {};
                    var evt = o['event'] || {};
                    return !(e.hostname && !dcsObject.dcsIsOnsite(e.hostname, dcsObject._onsitedoms) && !dcsObject._isRightClick(evt));
                },
        ...
        addAllLinkTracking: function () {
            this.addSelector('a', {
                filter: function (dcsObject, o) {
                    var e = o['element'] || {};
                    var evt = o['event'] || {};
                    return !(dcsObject.dcsIsOnsite(e.hostname, dcsObject._onsitedoms) && !dcsObject.dcsTypeMatch(e.pathname, dcsObject._downloadtypes) && !dcsObject._isRightClick(evt));
                },
                transform: function (dcsObject, o) {
                    var e = o['event'] || {};
                    var el = o['element'] || {};
        ...
        addAnchorTracking: function (evt) {
            this.addSelector('a', {
                filter: function (dcsObject, o) {
                    var e = o['element'] || {};
                    var evt = o['event'] || {};
                    return !(dcsObject.dcsIsOnsite(e.hostname, dcsObject._onsitedoms) &&
        ...
        addRightClickTracking: function () {
            this.addSelector('a', {
                filter: function (dcsObject, o) {
                    var e = o['element'] || {};
                    var evt = o['event'] || {};
                    return !(dcsObject.dcsTypeMatch(e.pathname, dcsObject._downloadtypes) &&
        ...
        addJavaScriptTracking: function () {
            this.addSelector('a', {
                filter: function (dcsObject, o) {
                    var e = o['element'] || {};
                    var evt = o['event'] || {};
                    return !(e.href && e.protocol && e.protocol.toLowerCase() == "javascript:");
                },
                transform: function (dcsObject, o) {
                    var e = o['event'] || {};
                    var el = o['element'] || {};
