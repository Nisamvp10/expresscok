     <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header">
                            ...
                            <small>Edit Author Details</small>
                        </h3>
                        <ol class="breadcrumb act_msg">
                            ...
                            <li>
                                <i class="fa fa-user-plus"></i> <a href="<?php echo base_url("admin/".$active."/".$actived);?>">Authors</a>
                            </li>
                            <li class="active">
                ...
                <form role="form" enctype="multipart/form-data" method="post" id="custom_fom" action="<?php echo base_url("admin/".$active."/".$actived."/save");?>">
			                	...
			                	<div class="col-lg-12">
						            ...
						            <div class="row">
							               ...
							               <div class="col-lg-5">
							                            <div class="form-group">
							                                <label>About</label>
							                                <textarea id="address" rows="5" class="form-control"  name="meta_content" ><?php if(isset($result_id[0]['meta_content']))echo $result_id[0]['meta_content'];?></textarea>
				        ...
				        <div class="form-group">    
			                <button type="submit" id="save_custom_values" data-url="<?php echo base_url("admin/".$active."/".$actived."/save");?>" data-id="<?php echo (isset($result_id[0]['id']))?$result_id[0]['id']:"";?>" data-config="edit" class="btn btn-default">Save Changes</button>
			                <div class="facebookG">
                ...
                <div class="row gallery_list">
	                ...
	                <div class="panel panel-info">
                            <div class="panel-heading">
                                <h3 class="panel-title">Authors List</h3>
