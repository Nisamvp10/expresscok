            ...
            <div class="calc_right_inner">
                ...
                <div class="row" style="padding: 10px 0px 15px 0px;">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12" style="padding-top: 10px;">
                        ...
                        <input type="radio" name="unit" value="inch" style="margin-left: 20px;"/>&nbsp;inches/pounds
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-7 col-md-8 col-sm-8 col-xs-12 calc_input">
                        <div class="row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12"><input id="length" type="text" name="length" value="" style="float: left; width: 40%;border: 1px solid #cbcbcb;color: #666679;"/>&nbsp;&nbsp;<p style="float: left;" class="print_unit"></p></div>
                        </div>
                        <div class="row">
                            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12"><label>Width:</label></div>
                            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12"><input id="width"  type="text" name="width" value="" style="float: left; width: 40%;border: 1px solid #cbcbcb;color: #666679;"/>&nbsp;&nbsp;<p style="float: left;" class="print_unit"></p></div>
                        </div>
                        <div class="row">
                            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12"><label>Height:</label></div>
                            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12"><input id="height" type="text" name="height" value="" style="float: left; width: 40%;border: 1px solid #cbcbcb;color: #666679;"/>&nbsp;&nbsp;<p style="float: left;" class="print_unit"></p></div>
                        </div>
                        <div class="row">
                    ...
                    <div class="col-lg-5 col-md-4 col-sm-4 col-xs-12">
                        <img src="images/Courier-Man.png" alt="image" />
                    </div>
                </div>
...
$(document).on("change","input[type=radio]",function(){
    ...
    document.getElementsByClassName("print_unit").innerHTML = unit;
});
</script>
