...
require_once(APPPATH."views/payment/razorpay/Razorpay.php");
...
class Register extends CI_Controller {
  ...
  public function pay()
  {
    $api = new Api('rzp_test_50ho0aPskgbUgB', '6C4t3xXJLI3oO9YKISHpxCSs');
    /**
    ...
    $this->load->view('raz/rezorpay',array('data' => $data));
  }
  /**
