     <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <form role="form" enctype="multipart/form-data" method="post" action="<?php echo base_url('admin/web-settings/slider/home-directory/directory-settings/slider-one/save');?>">
		                		 ...
		                		 <div class="row">
		                		 	   <div class="panel panel-primary">
					                            <div class="panel-heading">
					                                <h3 class="panel-title">Select Home Slider</h3>
											                                ...
											                                <select name="slider" id="slider" class="form-control">
											                                	...
											                                	<?php if(isset($slider_result)){
																					foreach($slider_result as $row){ ?>
																						...
																						<option <?php if(isset($result[0]['meta_id'])&&$row['id']==$result[0]['meta_id']){ echo "selected";}  ?> value="<?php echo $row['id'];?>"><?php echo $row['name'];?></option>
                ...
                <form role="form" enctype="multipart/form-data" method="post" action="#">
		                ...
		                <button type="submit" id="save_seo_content" data-url="<?php echo base_url("admin/seo-settings/directory/seo");?>"; class="btn btn-default">Save Changes</button>
