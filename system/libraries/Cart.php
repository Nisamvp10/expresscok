...
class CI_Cart {
	...
	function _insert($items = array())
	{
		...
		// For example, what if someone buys two identical t-products (same product ID), but in
		// different sizes?  The product ID (and other attributes, like the name) will be identical for
		// both sizes because it's the same product. The only difference will be the size.
