			                		...
			                		<div class="row">
											...
											<div class="col-lg-6">              
						                    	        <div class="form-group">
							                                ...
							                                <textarea id="meta_content" class="form-control"  name="meta_content"></textarea>
												   ...
												   <div class="col-lg-6">
														<div class="form-group">
															...
															<div class='input-group date datetimepicker' >
																<input type="text" id="meta_file" class="form-control"  name="meta_file">
															...
															?>
															  <tr id="course_list_tr_<?php echo $row['id'];?>">
															    ...
															    <td><article><div class="tble_content_edtd">
						                                        	<span><?php echo $row['meta_content']; ?></span>
						                                        ...
						                                        <td><article><div class="tble_category_edt">
						                                        	...
						                                        	<span><?php echo $row['meta_file']; ?></span>
						                                        	
						                                        </div></article></td>
						                                        
						                                        
						                                        <td><article><div class="tble_file"><?php  echo (isset($row['m_file'])&&$row['m_file']!="")?'<img src="'.base_url().$row['m_file'].'" width="36px"/>':''; ?></div></article></td>
						                                       
						                                        
															    <td class="status-indication" >
															    	 <form class="display_show" id="status_change_<?php echo $row['id'];?>" method="post" action="<?php echo base_url('admin/bodhitreebooks/blog/create/status');?>">
