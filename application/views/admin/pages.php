     <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                	<form role="form" enctype="multipart/form-data" method="post" action="<?php echo base_url();?>admin/developer/pages/save">
	                    <div class="col-lg-5">
	                            ...
	                            <button type="submit" class="btn btn-default spin-waiter">Save Page</button>
