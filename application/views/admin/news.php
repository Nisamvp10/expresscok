     <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header">
                            ...
                            <small>Add New News Scroll</small>
                        </h3>
                        <ol class="breadcrumb">
                            <li>
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> News Scroll
                            </li>
                ...
                <div class="row">
                	<form role="form" enctype="multipart/form-data" method="post" action="<?php echo base_url();?>admin/news_scroll/save">
	                    <div class="col-lg-5">
	
	                            <div class="form-group">
	                                <label>News</label>
	                               <textarea id="meta_content" class="form-control"  name="content"></textarea>
	                                <input type="hidden" value="<?php echo $f;?>" class="form-control" name="rurl">
	                                <input type="hidden" value="news_scroll" class="form-control" name="mode">
															...
															?>
															  <tr id="course_list_tr_<?php echo $row['id'];?>">
						                                        ...
						                                        <td style="position:relative;">
						                                          <article>
						                                        	<form style="display: inline-block;" id="course_form_<?php echo $row['id'];?>" class="course_edit_form" action="<?php echo base_url('admin/news_scroll/edit');?>" method="post">
						                                        		<input type="hidden" value="<?php echo $f;?>" class="form-control" name="rurl">
