     <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                	<form role="form" enctype="multipart/form-data" method="post" action="<?php echo base_url();?>admin/developer/pages/update">
	                    <div class="col-lg-5">
	                            <div class="form-group">
	                                <label>Page Name</label>
	                                <input type="text" class="form-control" name="name" value="<?php echo (isset($result_id[0]['name']))?$result_id[0]['name']:"";?>" />
	                    ...
	                    <div class="col-lg-4">
	                           <div class="form-group">
		                           <label>Page's Friendly Name</label>
		                           <input type="text" class="form-control" value="<?php echo (isset($result_id[0]['content']))?$result_id[0]['content']:"";?>" name="content">
		                       </div>
															...
															?>
															  <tr id="course_list_tr_<?php echo $row['id'];?>">
															    ...
															    <td>
															     ...
															     <td>
															    	<article><div class="tble_name"><?php echo $row['content']; ?></div></article>
						                                        ...
						                                        <td style="position:relative;">
						                                          <article>
						                                        	<form style="display: inline-block;" id="course_form_<?php echo $row['id'];?>" class="course_edit_form" action="<?php echo base_url('admin/developer/pages/edit');?>" method="post">
