     <div id="page-wrapper">
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                ...
                                <i class="fa fa-book"></i> <a href="<?php echo base_url();?><?php echo (isset($rurl))?dirname(dirname($rurl)):""  ?>"><?php echo (isset($mode))?$mode:"";?></a>
                            </li>
                            <li class="active">
                            	
                                <i class="fa fa-file"></i> <a href="<?php echo base_url();?><?php echo (isset($rurl))?dirname($rurl):""  ?>">Category</a>
                            </li>
                            <li class="active">
                            	
                                <i class="fa fa-file"></i> <a href="<?php echo base_url();?><?php echo (isset($rurl))?$rurl:""  ?>">Subcategory</a>
                            </li>
                ...
                <div class="row">
                	<form role="form" enctype="multipart/form-data" method="post" action="<?php echo base_url('admin/category/sub-category/update');?>">
									...
									<select name="meta_id" class="form-control" >
										<?php 	if(isset($category)){
																	foreach($category as $key => $row){ 
																		?>
																	<option <?php if(isset($result[0]['meta_id'])&&$result[0]['meta_id']==$row['id'])echo "selected";?> value="<?php echo $row['id'];?>"><?php echo $row['name'];?></option>
															<?php  }   }  ?>	
									</select>
								</div>
							</div>
