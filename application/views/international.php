...
<ol class="breadcrumb">
    ...
    <li>Services</li>
    <li class="active">International Document Delivery Services</li>
</ol>
<style>
            ...
            <div class="confirm-details">
                <div class="row">                    
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <img src="<?php echo resource('frontend')?>images/si2.jpg" alt="image" />
                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <!--<img src="<?php echo resource('frontend')?>images/si3.jpg" alt="image" />-->
                    </div>
                </div>
                ...
                <div class="row">
                    <ul>
                        <div class="col-md-4 col-sm-4 col-xs-12 centercontent"><li><img src="<?php echo resource('frontend')?>images/document.png" /><h6>Document Express (DOX)</h6></li></div>
                        <div class="col-md-4 col-sm-4 col-xs-12 centercontent"><li><img src="<?php echo resource('frontend')?>images/package.png" /><h6>Package Express (WPX)</h6></li></div>
                        <div class="col-md-4 col-sm-4 col-xs-12 centercontent"><li><img src="<?php echo resource('frontend')?>images/cargo.png" /><h6>Cargo Express</h6></li></div>
                    </ul>
                </div>
                ...
                <ul>
                    <li>&raquo;&nbsp;Door to door services</li>
                    <li>&raquo;&nbsp;Custom Clearance expertise</li>
                    <li>&raquo;&nbsp;Unmatched value for money prices for domestic and international courier service</li>
                    <li>&raquo;&nbsp;International packages will be delivered in 4 to 6 business days</li>
                    <li>&raquo;&nbsp;Free packing</li>
                    <li>&raquo;&nbsp;Each shipment carries insurance</li>
                    <li>&raquo;&nbsp;Reach to 220+ countries world wide</li>
                    <li>&raquo;&nbsp;Packaging for international travel proof</li>
                    <li>&raquo;&nbsp;Simple documentation</li>
                    <li>&raquo;&nbsp;We carry anything globally</li>
                    <li>&raquo;&nbsp;Power to choose between normal delivery and express/ same say delivery</li>
                    <li>&raquo;&nbsp;Detailed real time online tracking</li>
                    <li>&raquo;&nbsp;Money back guarantee</li>
                    <li>&raquo;&nbsp;Online payment option</li>
                    <li>&raquo;&nbsp;Easy shipment planning services</li>
                    <li>&raquo;&nbsp;Free home pick – up</li>
                </ul>
