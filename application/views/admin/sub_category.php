     <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="page-header">
                            <?php echo (isset($mode))?$mode:"";  ?> <i class="fa fa-angle-double-right"></i>
                            <small style="  font-size: 93%;color: #777;"><?php echo isset($cat_result[0]['name'])?$cat_result[0]['name']:"";  ?></small>
                            <small><i class="fa fa-angle-double-right"></i> Add New Subcategory</small>
                        </h2>
                        <ol class="breadcrumb">
                            <li>
                            ...
                            <li class="active">
                                ...
                                <i class="fa fa-book"></i> <a href="<?php echo base_url(dirname(dirname(dirname($f))));?>"><?php echo (isset($mode))?$mode:"";?></a>
                            </li>
                            <li class="active">
                                <i class="fa fa-file"></i><a href="<?php echo base_url(dirname(dirname($f)));?>"> Category</a>
                            </li>
                            
                            <li class="active">
                                <i class="fa fa-file"></i> Subcategory
                            </li>
                ...
                <div class="row">
                	<form role="form" enctype="multipart/form-data" method="post" action="<?php echo base_url();?>admin/category/sub-category/save">
						...
						<div class="col-lg-5">
	                            ...
	                            <div class="form-group">
	                                ...
	                                <input type="hidden" value="<?php echo isset($f)?$f:"";?>" class="form-control" name="rurl">
	                                
	                                <input type="hidden" value="<?php echo strtolower(isset($mode)?$mode:"");?>" class="form-control" name="meta_mode">
	                    ...
	                    <div class="col-lg-4">
	                            ...
	                            <button type="submit" class="btn btn-default spin-waiter">Save Subcategory</button>
                ...
                <div class="row gallery_list">
                        ...
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                <h3 class="panel-title">All Subcategories</h3>
															...
															?>
															  <tr id="course_list_tr_<?php echo $row['id'];?>">
						                                        ...
						                                        <td style="position:relative;">
						                                          <article>
						                                        	<form style="display: inline-block;" id="course_form_<?php echo $row['id'];?>" class="course_edit_form" action="<?php echo base_url('admin/category/sub-category/edit');?>" method="post">
															    	 ...
															    	 <a id="gggggg"  class="seo_de_a"  href="<?php echo base_url("admin/global-seo-settings/posts/".strtolower(isset($mode)?$mode:"")."/subcategory/".$row['id']);?>"><i class="fa fa-wrench list_delete_s"></i>Settings</a>
