     <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                	<form role="form" enctype="multipart/form-data" method="post" action="<?php echo base_url();?>admin/category/save">
	                    <div class="col-lg-5">
	                    ...
	                    <div class="col-lg-4" style="margin-top:25px;">
	                            ...
	                            <button type="submit" class="btn btn-default spin-waiter">Save Category</button>
