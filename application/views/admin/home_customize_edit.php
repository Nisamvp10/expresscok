     <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> Edit Content
                            </li>
                ...
                <form role="form" enctype="multipart/form-data" method="post" action="#">
			                		...
			                		<div class="row">
						                   <div class="col-lg-6">
						                            ...
						                            <div style="display: none;" class="form-group">
						                                ...
						                                <input id="url" value="<?php echo (isset($result_id[0]['meta_file']))?$result_id[0]['meta_file']:"";?>" class="form-control"  name="url">
						                            </div> 
						                    ...
						                    <div style="display: none;" class="col-lg-6">
						                    	        <div class="form-group">
							                                ...
							                                <textarea id="description" rows="5" class="form-control"  name="description" ><?php echo (isset($result_id[0]['meta_content']))?$result_id[0]['meta_content']:"";?></textarea>
						                            	 ...
						                            	 <div style="display: none;" class="row">
											            	    <div class="col-lg-3">
											            	    	   <div class="form-group">
											                                ...
											                                <input type="hidden" value="<?php echo (isset($result_id[0]['file']))?$result_id[0]['file']:"";?>" class="form-control" id="e_files" name="e_file">
											            	    	   ...
											            	    	   <?php if(isset($result_id[0]['m_file'])&&$result_id[0]['m_file']!=""){?>
											                            	<div class="form-group ex_image_holder">	
											                            		<div style="position: relative;">
											                            			<?php 
											                            			          $path_parts = pathinfo(base_url($result_id[0]['m_file']));
																  		                      if($path_parts['extension']=="swf"){ ?>
																  		                      	         
																	      	                                   
																	      	                                   <object width="100%" height="auto" data="<?php echo base_url($result_id[0]['m_file']); ?>"></object>
											                            		...
											                            		<div class="remv_feat_img">
											                            			...
											                            			<a id="rmove_co_img" data-id="<?php echo (isset($result_id[0]['id']))?$result_id[0]['id']:""; ?>" href="<?php echo base_url('admin/remove-image/posts');?>">Remove featured image.</a>
											                                ...
											                                <select name="slider" id="slider" class="form-control">
											                                	...
											                                	<?php if(isset($slider_result)){
																					foreach($slider_result as $row){ ?>
																						...
																						<option <?php if($row['id']==$result_id[0]['meta_id']){ echo "selected";}?> value="<?php echo $row['id'];?>"><?php echo $row['name'];?></option>
	                ...
	                <button type="submit" id="save_home_custome" data-config="edit" data-id="<?php echo (isset($result_id[0]['id']))?$result_id[0]['id']:"";?>" data-url="<?php echo base_url("admin/".$active."/customisation")?>" class="btn btn-default">Save Changes</button>
